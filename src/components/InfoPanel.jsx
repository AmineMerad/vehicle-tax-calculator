...
export default function InfoPanel({ darkMode }) {
  ...
  const InfoItem = ({ item }) => {
    ...
    return (
      <div className="border-b border-gray-100 dark:border-gray-700 last:border-b-0 py-4">
        <button
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-700 overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 px-8 py-6 border-b border-gray-100 dark:border-gray-600">
          <button
        ...
        <div className={`transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
          {/* Tabs */}
          <div className="flex flex-wrap border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
            {tabs.map((tab) => {
              const Icon = tab.icon
              return (
                <button
          ...
          {/* Warning Footer */}
          <div className="bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900 dark:from-opacity-20 dark:to-orange-900 dark:to-opacity-20 border-t-2 border-red-200 dark:border-red-700 p-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-red-700 dark:text-red-200 leading-relaxed mb-3">
          ...
          <div className="p-6 bg-gray-50 dark:bg-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-center">
              <div className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                ...
                <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Véhicules électriques</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">-80% de taxes</div>
              </div>
              <div className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="text-2xl mb-2">🚗</div>
                <div className="text-xs font-medium text-gray-700 dark:text-gray-300">≤ 1800cc</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">-50% de taxes</div>
              </div>
              <div className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="text-2xl mb-2">📅</div>
                <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Âge maximum</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">36 mois</div>
              </div>
              <div className="p-3 bg-white dark:bg-gray-800 rounded-lg shadow-sm">
                <div className="text-2xl mb-2">⛽</div>
                <div className="text-xs font-medium text-gray-700 dark:text-gray-300">Diesel</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Interdit</div>
              </div>
            </div>
          </div>
        )}
